...
public class OutputCore {
    ...
    public static void save(String fileName, Core core, Collection collection) throws IOException {
        ...
        try {
            ...
            if(file.exists()) {
                ...
                core.script();
            }else{System.out.println("Файл перемещён или удалён."); core.script();}
        }
    }
}
